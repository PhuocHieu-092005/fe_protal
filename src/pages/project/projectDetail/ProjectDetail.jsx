  ...
  useEffect(() => {
    const fetchComments = async () => {
      ...
      try {
        ...
        console.error("Lỗi lấy comment project:", error);
        setComments([]);
      } finally {
              ...
              {user?.role === "COMPANY" && (
                <section className="rounded-[2.5rem] border border-slate-100 bg-white p-8 shadow-sm">
                  ...
                  <p className="mb-5 text-sm leading-relaxed text-slate-600">
                    Nếu bạn là doanh nghiệp và muốn hợp tác hoặc xin quyền truy
                    cập project này, hãy gửi yêu cầu để admin xem xét và phản
                    hồi.
                  </p>
