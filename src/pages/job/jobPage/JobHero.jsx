      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 md:px-6 md:py-32">
          <div className="mx-auto max-w-4xl text-center text-white">
            <span className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs md:px-4 md:text-sm backdrop-blur">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-2 text-xs text-slate-200 md:mt-8 md:gap-3 md:text-sm">
              <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 md:px-4 md:py-2">
                ReactJS
              </span>
              <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 md:px-4 md:py-2">
                NodeJS
